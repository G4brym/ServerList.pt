				...
				<div class="row">
					<div class="col-lg-12">
						<div class="intro-message">
							 <img src="{{ URL::to('/resources/images/website/logo-medium.png') }}" class="img-responsive center-block" alt="Logo"> 
...
@section('body')
		...
		<div class="row">
			<div class="col-md-6">
				...
				<a href="https://mega.nz/#!DwwG3CpL!S-fQeWhqW9N9onQ8VJ31QYqXQPGAw82n-Slxsnt3KvY" target="_blank" class="btn btn-info"><i class="fa fa-windows"></i> Download Windows</a> <a href="https://mega.nz/#!etQgQDyS!pLuW3qhHhhmUsFdqOgAlmyOQ8uwvdoMSWiXayS-9qAI" target="_blank" class="btn btn-info"><i class="fa fa-linux"></i> Download Linux/MAC</a>
			</div><br>
			<div class="col-md-6">
