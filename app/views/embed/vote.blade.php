...
<a href="<?php if($gm == "mc"){ echo URL::to('/minecraft/'.$server->mcs_id); } ?>" class="btn btn-inverse btn-small" style="background: #4caf50;" target="_blank">Vota Em <strong>ServerList.pt</strong></a>
